...
{
    internal class PlayerInputMenuComponent : Menu
    {
        private string _text;
        private Action<string> _submit;

        public PlayerInputMenuComponent(GraphicViewerGame game, Action<string> submit)
            : base(game, "File ? &L".PadRight(33, ' '))
        {
            Font.Paper = SpectrumColor.Blue;
            Font.Ink = SpectrumColor.Yellow;
            _text = "";
            _submit = submit;
        }
        ...
        public override void Process(Keys key)
        {
            ...
            MenuShape = $"File ? {_text}&L".PadRight(33, ' ');
        }

        // From https://www.reddit.com/r/monogame/comments/70j259/code_how_to_convert_an_xnamonogame_key_to_a/
